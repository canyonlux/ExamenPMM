...
public class MoveDetailFragment extends Fragment { // Fragmento para el detalle de los movimientos

    private FragmentMoveDetailBinding binding; // Binding para el fragmento
    MovesViewModel movesViewModel; // ViewModel para los movimientos
